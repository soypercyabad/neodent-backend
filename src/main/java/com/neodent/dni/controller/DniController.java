...
@Tag(
    name = "Consulta DNI",
    description = "Consulta datos de identidad mediante el proveedor externo Apis.net"
)
public class DniController {
    ...
    @Operation(
        ...
        description = """
            ...
            Este servicio se usa únicamente cuando el paciente todavía
            no existe en la base de datos de Neodent.

            Si el proveedor externo falla, el flujo de registro debe
    ...
    @ApiResponses({
        @ApiResponse(
            responseCode = "200",
            description = "DNI consultado correctamente"
        ),
        @ApiResponse(
            responseCode = "400",
    ...
    public DniResponse buscarPorDni(
        ...
        @Parameter(
            description = "DNI peruano de 8 dígitos",
            example = "75195123"
        )
